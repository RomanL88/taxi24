        ...
        <div class="content_cond">
            ...
            <div class="conditions-cards">
                ...
                <div data-aos="fade-left" class="condition-item">
                    <p>Выплаты денежных средств производятся на карту любого банка моментально через приложение Jump Taxi.
...
<section class="winner_prize" id="winner_prize">
    <div class="container container__winner">
        ...
        <div data-aos="fade-left" class="winner">
            ...
            <div class="winner-img"><img src="/images/winner.png" alt=""></div>
...
<section class="lottery">
    <div class="container">
        <div data-aos="fade-up" class="card-container card-container__no_left card-container__lottery">
            <div class="card-image">
                <img class="tender" src="/images/card-5.png" alt="">
            </div>
    ...
    <div class="container">
        ...
        <div class="accordion">
                ...
                <ul class="accordion__items">
                    <li class="accordion__item">
                        ...
                        <div class="accordion__content">
                            <p>У нас дружный коллектив, прозрачные условия работы, новые машины для аренды оснащенные световыми коробами, видео-регистраторами, детскими креслами и газовым оборудованием</p>
                        </div>
                    </li>
                    <li class="accordion__item">
                        <div class="accordion__title">
            ...
            <div class="accordion_2">
                ...
                <div class=""><button id="button" class="more_btn">Показать еще</button></div>
            </div>
...
<section class="footer-form" id="feedback">
    <div class="container__form">
        <div data-aos="zoom-in-left" class="form">
            <h2>Оставляйте заявку <p>на подключение к Яндекс.Такси</p>
            </h2>
            <br>
            <br>
