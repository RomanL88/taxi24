...
?><div class="swiper">
	...
	<div class="swiper-wrapper" style="max-width: 1440px">
		 <!-- Slides --> <!--      <div class="swiper-slide">--> <!--        <div class="slide-1">--> <!--          <div class="col1">--> <!--            <span>Работа водителем такси в Уфе</span>--> <!--            <h2>Каждый пятый день работы – без процентов и комиссий таксопарка</h2>--> <!--            <button class="btn_slide_partner">Стать партнером</button>--> <!--            <br>--> <!--            <button class="btn_slide_ya"><img src="/images/ya_slider.png" alt="">Официальный партнер Яндекс.Такси</button>--> <!--          </div>--> <!--          <div class="col2">--> <!--            <img src="/images/banner-1.png" alt="">--> <!--          </div>--> <!--        </div>--> <!--      </div>-->
 ...
 <img src="/local/templates/main/images/slider/slide1.png" alt="">
	 ...
	 <!-- If we need navigation buttons --> <!--    <div class="swiper-button-prev"></div>--> <!--    <div class="swiper-button-next"></div>--> <!-- If we need scrollbar --> <!--    <div class="swiper-scrollbar"></div>-->
</div>
 <section class="privilege" id="about">
<h2 class="text-center"></h2>
 <!-- слайдер 1 - пробный  --> <?$APPLICATION->IncludeComponent(
	"bitrix:news.list",
	"slider_index",
	Array(
...
<div class="container">
 ...
 </section> <section class="winner_prize" id="winner_prize">
<div class="container container__winner">
 ...
 </section> <section class="calc" id="payment">
...
<div class="container w-100">
 ...
 </section> <section class="question_answer" id="question_answer">
<div class="container">
 ...
 </section> <section class="footer-form" id="feedback">
